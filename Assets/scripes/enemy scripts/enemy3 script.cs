...
public class enemy3script : MonoBehaviour
{
    ...
    IEnumerator explosion()
    {
        ...
        agent.destination = transform.position; // Stop the enemy from moving
        
        SphereCollider sphereCollider = gameObject.AddComponent<SphereCollider>();
        sphereCollider.radius = 5f; // Set the radius for the explosion
        sphereCollider.isTrigger = true; // Make it a trigger collider
